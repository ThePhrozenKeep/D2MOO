...
D2FUNC_DLL_NP(STORM, SMemAlloc, void*, __stdcall, (int amount, char *logfilename, int logline, int defaultValue), 0x1b130);  //Storm.#401
...
D2FUNC_DLL_NP(STORM, SMemFree, BOOL, __stdcall, (void *location, char *logfilename, int logline, int defaultValue), 0x1c2e0);  //Storm.#403

/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SMemGetSize, int, __stdcall, (void *location, char *logfilename, int logline), 0x1c4f0);  //Storm.#404

/// Imported by ['D2CMP.dll', 'D2Game.dll', 'D2Client.dll']
D2FUNC_DLL_NP(STORM, SMemReAlloc, void*, __stdcall, (void *location, int amount, char *logfilename, int logline, int defaultValue), 0x1ce40);  //Storm.#405
...
/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SErrDisplayError, int, __stdcall, (DWORD dwMessageId, int, int, int, int, UINT uExitCode), 0x12020);  //Storm.#461
...
D2FUNC_DLL_NP(STORM, SStrCopy, int, __stdcall, (char *dest, const char *source, size_t size), 0x2a120);  //Storm.#501
...
/// Imported by ['D2Client.dll']
D2FUNC_DLL_NP(STORM, SStrTokenize, void, __stdcall, (const char** string, char* ppTokenizeBeginChar, char* buffer, const char* delimiter, size_t size), 0x2abe0);  //Storm.#504

/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SStrPack, char*, __stdcall, (const char *string, char c, int type), 0x2a060);  //Storm.#505

/// Imported by ['D2Launch.dll', 'Fog.dll', 'D2MCPClient.dll', 'D2Multi.dll', 'D2Game.dll', 'D2Client.dll']
D2FUNC_DLL_NP(STORM, SStrLen, int, __stdcall, (const char *string), 0x2a330);  //Storm.#506

/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SStrDup, void*, __stdcall, (int a1), 0x2a260);  //Storm.#507

/// Imported by ['D2Launch.dll', 'Fog.dll', 'D2Client.dll']
D2FUNC_DLL_NP(STORM, SStrCmp, int, __stdcall, (const char *Str1, const char *Str2, size_t MaxCount), 0x2a0a0);  //Storm.#508

/// Imported by ['D2Launch.dll', 'Fog.dll', 'D2CMP.dll', 'D2Common.dll', 'D2Game.dll', 'D2Client.dll']
D2FUNC_DLL_NP(STORM, SStrCmpI, int, __stdcall, (const char *Str1, const char *Str, size_t MaxCount), 0x2a0e0);  //Storm.#509

/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SStrUpper, int, __stdcall, (char *Str), 0x2b240);  //Storm.#510
...
/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SErrDisplayErrorFmt, int, __cdecl, (DWORD dwMessageId, int, int, int, UINT uExitCode, char *Format, char Args), 0x12570);  //Storm.#562
...
D2FUNC_DLL_NP(STORM, SStrChr, char*, __stdcall, (const char *string, char c), 0x29fe0);  //Storm.#571

/// Imported by ['Fog.dll']
D2FUNC_DLL_NP(STORM, SStrChrR, char*, __stdcall, (const char *string, char c), 0x2a020);  //Storm.#572
...
/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SStrToInt, signed int, __stdcall, (const char *string), 0x2aa10);  //Storm.#575
...
D2FUNC_DLL_NP(STORM, SStrVPrintf, int, __cdecl, (char *DstBuf, size_t MaxCount, char *Format, char ArgList), 0x2a570);  //Storm.#578
...
/// Not imported by any .dll
D2FUNC_DLL_NP(STORM, SStrPrintf, int, __cdecl, (char *DstBuf, size_t MaxCount, char *Format, va_list ArgList), 0x2a610);  //Storm.#581
