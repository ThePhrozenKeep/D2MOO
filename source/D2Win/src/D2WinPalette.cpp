...
int32_t __fastcall sub_6F8AE5E0(const char* szDatFileName, const char* szPL2FileName)
{
	...
	uint8_t* pDatFile = (uint8_t*)ARCHIVE_READ_FILE_TO_ALLOC_BUFFER(D2Win_GetArchive(), szDatFileName, nullptr);
	...
	D2PL2FileStrc* pPL2File = (D2PL2FileStrc*)ARCHIVE_READ_FILE_TO_ALLOC_BUFFER(D2Win_GetArchive(), szPL2FileName, nullptr);
