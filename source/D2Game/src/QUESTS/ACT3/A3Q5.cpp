...
void __fastcall ACT3Q5_InitQuestData(D2QuestDataStrc* pQuestData)
{
	...
	D2Act3Quest5Strc* pQuestDataEx = (D2Act3Quest5Strc*)FOG_AllocPool(pQuestData->pGame->pMemoryPool, sizeof(D2Act3Quest5Strc), __FILE__, __LINE__, 0);
...
int32_t __fastcall ACT3Q5_UnitIterate_UpdateQuestStateAfterMonsterKill(D2GameStrc* pGame, D2UnitStrc* pUnit, void* pData)
{
	...
	D2RoomStrc* pTargetRoom = UNITS_GetRoom(pTarget);
	if (!pTargetRoom)
	{
		return 0;
	}
