...
void __fastcall CCMD_ProcessClientSystemMessage(void* pData, int32_t nSize)
{
    ...
    case D2CLTSYS_NEWGAME:
    {
        ...
        {
            GAME_SendGameInit(nClientId, pPacket66->szGameName, pPacket66->nGameType, pPacket66->nPlayerClass, pPacket66->szClientName, pPacket66->dwArena, pPacket66->nGameFlags, pPacket66->nTemplate, pPacket66->unk0x2B, pPacket66->unk0x2C, pPacket66->nDifficulty, pPacket66->nLocale, 0, 0);
        }
        else
        {
