...
//D2Game.0x6FC8A1B0
int32_t __fastcall D2GAME_SAVE_WriteFileOnRealm_6FC8A1B0(D2GameStrc* pGame, D2UnitStrc* pPlayer, const char* szCharName, char* szAccountName, int32_t bInteractsWithPlayer, int32_t nBNetCharacterId, int32_t a7, D2ClientInfoStrc* pClientInfo)
{
    ...
    *(uint16_t*)pSaveData = nFileSize + 2;
    ...
    if (gpD2EventCallbackTable_6FD45830 && gpD2EventCallbackTable_6FD45830->pfSaveDatabaseCharacter)
    {
        ...
        gpD2EventCallbackTable_6FD45830->pfSaveDatabaseCharacter((int32_t*)&pClientInfo, szCharName, szAccountName, pSaveData, nFileSize + 2, nBNetCharacterId);
...
int32_t __fastcall D2GAME_SAVE_WriteFile_6FC8A500(D2GameStrc* pGame, D2UnitStrc* pPlayer, const char* szName, DWORD dwArg)
{
	...
	D2GAME_GetBNetCharacterId_6FC346A0(pClient, &nBNetCharacterId);
    ...
    {
        return D2GAME_SAVE_WriteFileOnRealm_6FC8A1B0(pGame, pPlayer, szName, szAccountName, bInteractsWithPlayer, nBNetCharacterId, dwArg, pClientInfo);
    }
