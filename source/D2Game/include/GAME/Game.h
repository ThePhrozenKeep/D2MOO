...
struct D2GameStrc : TSHashObject<D2GameStrc, HASHKEY_NONE> // called SGAMEDATA in original game
{
	...
	uint32_t unk0x1DC8;								//0x1DC8 (Removed in 1.11)
	uint32_t unk0x1DCC;								//0x1DCC (Removed in 1.11)
	uint32_t unk0x1DD0;								//0x1DD0 (Removed in 1.11)
	uint32_t unk0x1DD4;								//0x1DD4 (Removed in 1.11)
	uint32_t unk0x1DD8;								//0x1DD8 (Removed in 1.11)

	uint32_t unk0x1DDC;								//0x1DDC (1.11+: 0x1DC8)
	int32_t nWorldEventState;						//0x1DE0 (1.11+: 0x1DCC)
	int32_t dwWorldEventLastMessageFrame;			//0x1DE4 (1.11+: 0x1DD0)
