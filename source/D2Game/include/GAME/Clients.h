...
enum D2SystemError
{
	...
	SYSERROR_NEWBIE_SAVE = 2,
	SYSERROR_NO_CLIENT_NAME = 3,
	SYSERROR_CLIENT_ERROR = 4,
	SYSERROR_INVALID_SIZE = 5,
	SYSERROR_INVALID_CHECKSUM = 6,
	SYSERROR_NOT_COMPATIBLE = 7,
	SYSERROR_INVALID_ACT_OR_DIFFICULTY = 9,
	SYSERROR_HARDCORE_DEAD = 10,
	SYSERROR_NOT_HARDCORE_ARENA = 10,
	SYSERROR_HARDCORE_ARENA = 11,
	SYSERROR_PROGRESSION_NOT_NIGHTMARE = 13,
	SYSERROR_PROGRESSION_NOT_HELL = 14,
