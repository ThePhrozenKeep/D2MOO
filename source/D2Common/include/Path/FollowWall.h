...
struct D2PathFoWallContextStrc						  //sizeof 0x32EC
{
	...
	D2PathFoWallNodeStrc* aPendingCache[CACHE_SIZE];  //0x0000
	D2PathFoWallNodeStrc* aVisitedCache[CACHE_SIZE];  //0x0200
	D2PathFoWallNodeStrc* pSortedListByFScore;		  //0x0400
	D2PathFoWallNodeStrc aNodesStorage[STORAGE_SIZE]; //0x0404
	int32_t nNodesCount;							  //0x2FC4
	D2PathFoWallNodeStrc* aPointsStack[STACK_SIZE];   //0x2FC8
