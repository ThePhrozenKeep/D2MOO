...
D2COMMON_DLL_DECL int __stdcall WAYPOINTS_IsActivated(D2WaypointDataStrc* pData, uint16_t wField);
//D2Common.0x6FDC3E80 (#11147)
D2COMMON_DLL_DECL void __stdcall WAYPOINTS_ActivateWaypoint(D2WaypointDataStrc* pData, uint16_t wField);
//D2Common.0x6FDC3F20 (#11148)
D2COMMON_DLL_DECL D2WaypointDataStrc* __stdcall WAYPOINTS_AllocWaypointData(void* pMemPool);
//D2Common.0x6FDC3F70 (#11149)
D2COMMON_DLL_DECL void __stdcall WAYPOINTS_FreeWaypointData(void* pMemPool, D2WaypointDataStrc* pData);
