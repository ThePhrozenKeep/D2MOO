...
D2COMMON_DLL_DECL D2RoomStrc* __stdcall DUNGEON_GetAdjacentRoomByTileCoordinates(D2RoomStrc* pRoom, int nX, int nY);
...
D2COMMON_DLL_DECL void __stdcall DUNGEON_IsoSubTileToCartesianCoords(int* pX, int* pY);
//D2Common.0x6FD8D660 (#10112)
D2COMMON_DLL_DECL void __stdcall DUNGEON_IsometricToCartesianCoords(int* pX, int* pY);
//D2Common.0x6FD8D690 (#10107)
D2COMMON_DLL_DECL void __stdcall DUNGEON_CartesianToIsoTileCoords(int* pX, int* pY);
...
D2COMMON_DLL_DECL void __stdcall DUNGEON_CartesianToIsometricCoords(int* pX, int* pY);
//D2Common.0x6FD8D8C0 (#10113)
D2COMMON_DLL_DECL void __stdcall DUNGEON_IsoTileToSubtileCoords(int* pX, int* pY);
